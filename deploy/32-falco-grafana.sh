...
echo "     - falcosidekick_inputs : Nombre total d'événements reçus de Falco"
echo "     - falcosidekick_outputs : Nombre d'événements envoyés vers les outputs (Elasticsearch, WebUI)"
echo "     - falco_events : Événements Falco par règle, priorité et hostname"
echo ""
...
echo "  rate(falcosidekick_inputs[5m])"
echo ""
echo "  # Nombre d'alertes par destination"
echo "  sum by (destination) (falcosidekick_outputs)"
echo ""
echo "  # Alertes Falco par priorité"
echo "  sum by (priority) (falco_events)"
echo ""
echo "  # Top 5 règles Falco les plus déclenchées"
echo "  topk(5, sum by (rule) (falco_events))"
echo ""
echo "  # Nombre total d'événements reçus (compteur)"
echo "  falcosidekick_inputs"
echo ""
...
echo "     Query : rate(falcosidekick_inputs[5m])"
echo "     Type : Time series"
echo ""
echo "     Panel 2 : Alertes par destination (pie chart)"
echo "     Query : sum by (destination) (falcosidekick_outputs)"
echo "     Type : Pie chart"
echo ""
echo "     Panel 3 : Alertes par priorité"
echo "     Query : sum by (priority) (falco_events)"
echo "     Type : Time series"
echo ""
echo "     Panel 4 : Top 5 règles Falco"
echo "     Query : topk(5, sum by (rule) (falco_events))"
echo "     Type : Bar gauge"
echo ""
...
echo "  2. Graph → Query"
echo "  3. Taper : falcosidekick_inputs ou falco_events"
