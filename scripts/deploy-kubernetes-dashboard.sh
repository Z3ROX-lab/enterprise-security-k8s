...
echo ""
echo "⚠️  IMPORTANT - Avec Kind, vous devez utiliser un port-forward:"
echo ""
echo "   1️⃣  Configuration /etc/hosts:"
echo "      echo \"127.0.0.1 dashboard.local.lab\" | sudo tee -a /etc/hosts"
echo ""
echo "   2️⃣  Lancer le port-forward de l'Ingress (dans un terminal séparé):"
echo "      ./scripts/port-forward-ingress-stable.sh"
echo ""
echo "   3️⃣  Accéder au dashboard:"
echo "      https://dashboard.local.lab:8443/"
echo ""
echo "   ℹ️  Le port-forward doit rester actif pendant l'utilisation"
echo ""
